...
| `PRINTFN=` | `footnotes = hv_man_footnotes()` | on the save function; the house block assumes the default `percentiles` (15th, 85th) and must be overridden if `percentiles` is |
