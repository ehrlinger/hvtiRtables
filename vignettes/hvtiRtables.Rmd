...
for the Overall column `hv_tbl_summary()` adds by default, then one per
level of `trt`. The renderer lays out only the columns named here. The
labels are yours, including each column's N.
