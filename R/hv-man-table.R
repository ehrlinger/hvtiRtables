...
#' before the statistic it counts. Those are the same two values JTCVS
#' mode puts under a merged spanning header, without the merge. House
#' rule 8 wants that non-missing count, and [hv_man_footnotes()]'s `*`
