...
When you’re submitting to JTCVS, swap in
[`hv_man_table_jtcvs()`](https://ehrlinger.github.io/hvtiRtables/reference/hv_man_table_jtcvs.md)
/
...
The merged spanning header and lettered footnotes match the journal’s
own submission template, so you’re not hand-reformatting the table a
