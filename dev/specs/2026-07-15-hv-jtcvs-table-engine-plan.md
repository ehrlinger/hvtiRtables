...
- Per `dev/specs/2026-07-15-jtcvs-table-format-design.md`: one flexible engine, not per-archetype presets. Do not add `hv_table_baseline()`-style wrapper functions in this plan.
